    ...
    babelHelpers.createClass(Panel, [{
      ...
      value: function showContent() {
        if (this.isCollapse !== false) {
          ...
          var collapse_cache = this.$collapse.attr("data-id");
          if (typeof collapse_cache !== typeof undefined && collapse_cache !== false) {
              setCookie(collapse_cache, "showContent", 360);
          }
        }
      }
    }, {
      ...
      value: function hideContent() {
        ...
        if (this.isCollapse !== true) {
          ...
          var collapse_cache = this.$collapse.attr("data-id");
          if (typeof collapse_cache !== typeof undefined && collapse_cache !== false) {
            setCookie(collapse_cache, "hideContent", 360);
          }
        }
      }
    }, {
